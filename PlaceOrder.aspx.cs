...
public partial class PlaceOrder : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["pid"] != null)
            {
                if (Session["Buyitems"] == null)
                {
                    ...
                    String myquery = "select * from productdetails where pid=" + Request.QueryString["pid"];
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            String updatepass = "insert into orderdetails(orderid,sno,productid,productname,price,quantity,dateoforder) values('" + Label3.Text + "'," + dt.Rows[i]["sno"] + "," + dt.Rows[i]["pid"] + ",'" + dt.Rows[i]["name"] + "'," + dt.Rows[i]["price"] + "," + dt.Rows[i]["quantity"] + ",'" + Label4.Text + "')";
            con.Open();
            SqlCommand cmd1 = new SqlCommand();
            cmd1.CommandText = updatepass;
            cmd1.Connection = con;
