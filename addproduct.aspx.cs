    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            if (FileUpload1.HasFile)
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString);
                String query = "Update productdetails set name='" + TextBox2.Text + "', price='" + TextBox3.Text + "', describe='" + TextBox4.Text + "', img='" + pic + "' where id=" + TextBox1.Text;
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString);
                String query = "Update productdetails set name='" + TextBox2.Text + "', describe='" + TextBox4.Text + "', price='" + TextBox3.Text + "' where id=" + TextBox1.Text;
                SqlCommand cmd = new SqlCommand(query, con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        try
        {
            if (FileUpload1.HasFile)
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString);
                String query = "Insert into productdetails(name,cname,price,describe,img) values('" + TextBox2.Text + "','" + DropDownList1.SelectedValue.ToString() + "','" + TextBox3.Text + "','" + TextBox4.Text + "', '" + pic + "' )";
                SqlCommand cmd = new SqlCommand(query, con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
