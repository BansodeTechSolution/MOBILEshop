...
<tr align="center" >
<td align="right"><asp:Label ID="Label6" runat="server" Text="DESCRIPTION " CssClass="lbl"></asp:Label></td>
<td> <asp:TextBox ID="TextBox4" runat="server" Width="220px" CssClass="txt"></asp:TextBox></td>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="img" HeaderText="IMAGE" />
                  <asp:BoundField DataField="describe" HeaderText="DRICRIPATION" />
