...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
  ...
  <center><b>  YOUR HAVE PRODUCT IN YOUR CART  <asp:Label ID="lblcount" runat="server" Text=""></asp:Label></b>
    <br />
        ...
        <ItemTemplate>
            <table class="style1">
                ...
                <tr>
                    <td style="text-align: center">
                        DESCRIPTION :-
                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("describe") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                <td style="text-align: center">
                ...
                <td style="text-align: center">
                    ...
                    <asp:Button ID="Button1" runat="server" CommandName="addtocart" 
                        Text="ADD TO CART"  CommandArgument='<%# Eval("pid") %>'/>
